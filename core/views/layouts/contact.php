...
<body>
		...
		<div class="contactus">
			...
			<div class="glavMargin">
				<div class="form_two">
					<b>Наши телефоны:</b> <br>
					<p>+7 (727) 266 80 90; +7 (777) 394 66 44; +7 (777) 828 22 22</p>
					<br>
					<b>После 18.00:</b>	<br>
					<p>Просим оставлять сообщения на WhatsApp или СМС.</p>
					<br>
					<p><b>Время работы:</b> с 9.00-18.00 без выходных</p>

					<div class="contactsInputWrap">
							<form action="#" method="post" class="wrapForm">
									<div class="colums1">
										<div class="label"><label>Имя</label></div>
										<input type="text" required name="userName" id="outlineRed">
									</div>
									<div class="colums2">
										<div class="label"><label>Электронная почта (email)</label></div>
										<input type="email" required name="userEmail" id="outlineRed">
									</div>
									<div class="colums3">
										<div class="label"><label>Телефон</label></div>
										<input type="text" required name="userPhone" id="outlineRed">
									</div>
									<div class="colums4">
										<div class="label"><label>Комментарий</label></div>
										<textarea name="message" id="" cols="30" rows="10" id="outlineRed"></textarea>
									</div>
				...
				<div class="map_two">
					<p>Так же вы можете связаться с нами написав на: avtobak@gmail.com</p>
					<br>
					<p><b>Наш адрес: </b>Казахстан, г. Алматы, ул. Александрова 17 (вдоль БАКа нижняя сторона, между проспектом Сейфулина и ул. Жансугурова).</p>
					<br>
					<div class="mapContactTwo">
