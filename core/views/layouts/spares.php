...
<body>
		...
		<div class="modelTwo">
			<h2>Выберите необходимую запчасть</h2>
		</div>
		...
		<div class="centerBlock">
			<div class="marginCar">
				...
				<div class="badgesCar">
						<h3><?php if(empty($spares)) {echo "По данной категории запчастей еще нет";} else { echo "Запчасти по данной категории"; }?></h3>
						<div class="models">
								
								
								<?php for($i = 0; $i < count($spares); $i++): ?>
						 			<div class="markCar">
										<a href="/main/spare?id=<?= $spares[$i]['id']?>"><img src="/assets/img/<?= $spares[$i]['photo'];?>" alt="" class="obzorCar"></a>
										<div class="textTwo"><p><?= $spares[$i]['title'];?></p></div>
									</div>
			 			<?php endfor;?>
